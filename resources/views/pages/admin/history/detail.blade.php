...
<div class="main-content">
    <section class="section">
        ...
        <a href="{{ route('admin.history') }}" class="btn btn-icon icon-left btn-warning"> Kembali</a>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input id="total_harga" type="text" class="form-control" value="{{ $data->total_harga }}" readonly>
                        </div>
                    </div>
                </div>
            </div>
